...
const features = [
  {
    ...
    description:
      "Log every set, rep, and personal best. Build custom routines and watch your strength grow week over week with detailed session history.",
  ...
  },
  {
    ...
    description:
      "Monitor macros, calories, and hydration effortlessly. Search millions of foods and get smart insights to fuel your performance goals.",
  ...
  },
  {
    ...
    description:
      "Visualize your transformation with beautiful charts and trend reports. Celebrate milestones and stay motivated with data-driven feedback.",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-xl mx-auto">
              Three powerful pillars to transform the way you train, eat, and grow.
            </p>
          </div>
