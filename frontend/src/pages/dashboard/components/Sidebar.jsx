...
const user = { name: "Alex Johnson", avatar: "AJ", joinDate: "Member since Jan 2024" };
...
export default function Sidebar({ activePage, setActivePage }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 min-h-screen bg-white border-r border-gray-100 fixed top-0 left-0 z-30">
      {/* Logo — click karne par home page par jao */}
      <button
        onClick={() => navigate("/")}
        className="h-16 flex items-center gap-2 px-6 border-b border-gray-100 hover:bg-gray-50 transition-colors w-full text-left"
      >
